...
pyautogui.write(r"D:\Kitchen\KItchen_Installation\Kitchen_Kimchi.rpj")
pyautogui.press('enter')
...
pyautogui.write("D:\FOTA FWs\IH_COOKTOP\Tested\V1_FullBridge_IH_Merged_0x061FEABE.hex")
pyautogui.press('enter')
